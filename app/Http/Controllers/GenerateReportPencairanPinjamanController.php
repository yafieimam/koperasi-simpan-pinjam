...
use App\GenerateReportPencairanPinjaman;
...
class GenerateReportPencairanPinjamanController extends Controller
{
    /**
    ...
    public function getData(Request $request)
    {
        ...
        $dataLoan = DownloadReport::generatePencairanPinjaman($start, $end, $area, $proyek, $member_id);
        $output = '';
    ...
    public function download(Request $request){
        ...
        $proyek = $request->get('proyek');
        $member_id = $request->get('member_id');
        $genReportDeposit = DownloadReport::generatePencairanPinjaman($start, $end, $area, $proyek, $member_id);
        $spreadsheet = ReverseDataHelper::downloadPencairanPinjaman($genReportDeposit, $start, $end);
        $filename = 'Laporan Pencairan Pinjaman.xlsx';
