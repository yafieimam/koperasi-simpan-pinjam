...
@section('title', 'Tambah Generate Report Pencairan Pinjaman')

@section('content_header')
    <h1>Tambah Generate Report Pencairan Pinjaman</h1>
@stop
...
@section('appjs')
    ...
    <script type="text/javascript">
        $('.cari_area').select2({
            ...
            // allowClear: true,
            ajax: {
                url: '/generate/pencairan-pinjaman/get-area',
                dataType: 'json',
                delay: 250,
        ...
        function getProyek(area = ''){
            $('.cari_proyek').select2({
                ...
                // allowClear: true,
                ajax: {
                    url: '/generate/pencairan-pinjaman/get-proyek',
                    dataType: 'json',
                    delay: 250,
        ...
        function getMember(area = '', proyek = ''){
            $('.cari_member').select2({
                ...
                // allowClear: true,
                ajax: {
                    url: '/generate/pencairan-pinjaman/get-member',
                    dataType: 'json',
                    delay: 250,
                    data: function (params) {
                        return {
        ...
        $(document).ready(function () {
            $('#search_data').on('click', function () {
                ...
                $.ajax({
                    type: 'post',
                    url: '/generate/pencairan-pinjaman/get-data',
