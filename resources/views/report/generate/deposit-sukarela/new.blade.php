...
@section('title', 'Generate Report Pengambilan Sukarela')
...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-body">
                    {!! Form::open(['url' => 'generate/pengambilan-sukarela', 'method' => 'post']) !!}
                    @include('report.generate.deposit-sukarela.form')
                    {!! Form::close() !!}
...
@section('appjs')
    ...
    <script type="text/javascript">
        $('.cari_area').select2({
            ...
            // allowClear: true,
            ajax: {
                url: '/generate/pengambilan-sukarela/get-area',
                dataType: 'json',
                delay: 250,
        ...
        function getProyek(area = ''){
            $('.cari_proyek').select2({
                ...
                // allowClear: true,
                ajax: {
                    url: '/generate/pengambilan-sukarela/get-proyek',
                    dataType: 'json',
                    delay: 250,
        ...
        function getMember(area = '', proyek = ''){
            $('.cari_member').select2({
                ...
                // allowClear: true,
                ajax: {
                    url: '/generate/pengambilan-sukarela/get-member',
                    dataType: 'json',
                    delay: 250,
                    data: function (params) {
                        return {
        ...
        $(document).ready(function () {
            $('#search_data').on('click', function () {
                ...
                $.ajax({
                    type: 'post',
                    url: '/generate/pengambilan-sukarela/get-data',
