...
<div class="form-group">
    <label class="control-label col-md-3 col-sm-3 col-xs-4" for="name">Periode <span class="required">*</span>
    </label>
    <div class="col-md-9 col-sm-9 col-xs-8">
        {!! Form::date('periode',old('periode'), ['id' => 'periode', 'class' => 'form-control datepicker col-md-7 col-xs-12','placeholder'=>'Periode','required'=>true]) !!}
    </div>
</div>
<br/>
<div class="form-group">
