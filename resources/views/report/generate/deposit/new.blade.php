                    ...
                    <div class="form-group">
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <th colspan="2" scope="col" style="text-align: center;">Simpanan Pokok</th>
                                <th colspan="2" scope="col" style="text-align: center;">Simpanan Wajib</th>
                                <th colspan="2" scope="col" style="text-align: center;">Simpanan Sukarela</th>
                            </tr>
                            <tr>
                                <th scope="col" style="text-align: center;">Saldo Masuk</th>
                                <th scope="col" style="text-align: center;">Saldo Keluar</th>
                                <th scope="col" style="text-align: center;">Saldo Masuk</th>
                                <th scope="col" style="text-align: center;">Saldo Keluar</th>
                                <th scope="col" style="text-align: center;">Saldo Masuk</th>
                                <th scope="col" style="text-align: center;">Saldo Keluar</th>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('#search_data').on('click', function () {
                ...
                $.ajax({
                    type: 'post',
                    url: '/generate/deposit-report/get-data',
