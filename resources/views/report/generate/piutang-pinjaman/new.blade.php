...
@section('title', 'Tambah Generate Report Piutang Pinjaman')

@section('content_header')
    <h1>Tambah Generate Report Piutang Pinjaman</h1>
@stop
...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-body">
                    {!! Form::open(['url' => 'generate/piutang-pinjaman', 'method' => 'post']) !!}
                    ...
                    <div class="form-group">
                        ...
                        <table class="table table-striped">
                            <thead>
                            <tr>
                                <th rowspan="2" scope="col" style="text-align: center;">Bulan</th>
                                <th colspan="6" scope="col" style="text-align: center;">Jenis Pinjaman</th>
                            ...
                            <tr>
                                ...
                                <th scope="col" style="text-align: center;">Motorloan</th>
                                <th scope="col" style="text-align: center;">Bisnis</th>
                            </tr>
                            </thead>
                            <tbody id="edpinfo">
                            </tbody>
...
@section('appjs')
    ...
    <script type="text/javascript">
        $('.cari_area').select2({
            ...
            // allowClear: true,
            ajax: {
                url: '/generate/piutang-pinjaman/get-area',
                dataType: 'json',
                delay: 250,
        ...
        function getProyek(area = ''){
            $('.cari_proyek').select2({
                ...
                // allowClear: true,
                ajax: {
                    url: '/generate/piutang-pinjaman/get-proyek',
                    dataType: 'json',
                    delay: 250,
        ...
        function getMember(area = '', proyek = ''){
            $('.cari_member').select2({
                ...
                // allowClear: true,
                ajax: {
                    url: '/generate/piutang-pinjaman/get-member',
                    dataType: 'json',
                    delay: 250,
                    data: function (params) {
                        return {
        ...
        $(document).ready(function () {
            $('#search_data').on('click', function () {
                ...
                $.ajax({
                    type: 'post',
                    url: '/generate/piutang-pinjaman/get-data',
