...
@section('title', 'Generate Report Kredit Bermasalah')

@section('content_header')
    <h1>Generate Report Kredit Bermasalah</h1>
@stop
...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-body">
                    {!! Form::open(['url' => 'generate/kredit-bermasalah', 'method' => 'post']) !!}
                    @include('report.generate.kredit-bermasalah.form')
                    {!! Form::close() !!}
                    ...
                    <div class="form-group">
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <th rowspan="2" scope="col" style="text-align: center;">Sisa Kewajiban</th>
                                <th rowspan="2" scope="col" style="text-align: center;">Ket NPL</th>
                                <th rowspan="2" scope="col" style="text-align: center;">Ket Pelunasan</th>
                            </tr>
                            <tr>
...
@section('appjs')
    ...
    <script type="text/javascript">
        $('.cari_area').select2({
            ...
            // allowClear: true,
            ajax: {
                url: '/generate/kredit-bermasalah/get-area',
                dataType: 'json',
                delay: 250,
        ...
        function getProyek(area = ''){
            $('.cari_proyek').select2({
                ...
                // allowClear: true,
                ajax: {
                    url: '/generate/kredit-bermasalah/get-proyek',
                    dataType: 'json',
                    delay: 250,
        ...
        function getMember(area = '', proyek = ''){
            $('.cari_member').select2({
                ...
                // allowClear: true,
                ajax: {
                    url: '/generate/kredit-bermasalah/get-member',
                    dataType: 'json',
                    delay: 250,
                    data: function (params) {
                        return {
        ...
        $(document).ready(function () {
            $('#search_data').on('click', function () {
                ...
                $.ajax({
                    type: 'post',
                    url: '/generate/kredit-bermasalah/get-data',
