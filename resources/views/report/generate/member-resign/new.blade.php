                ...
                <div class="box-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <th rowspan="2" scope="col" style="text-align: center;">Tgl Resign</th>
                            ...
                            <th rowspan="2" scope="col" style="text-align: center;">Total Hak</th>
                        </tr>
                        <tr>
...
@section('appjs')
    ...
    <script type="text/javascript">
        $('.cari_area').select2({
            ...
            // allowClear: true,
            ajax: {
                url: '/generate/member-resign/get-area',
                dataType: 'json',
                delay: 250,
        ...
        function getProyek(area = ''){
            $('.cari_proyek').select2({
                ...
                // allowClear: true,
                ajax: {
                    url: '/generate/member-resign/get-proyek',
                    dataType: 'json',
                    delay: 250,
        ...
        $(document).ready(function () {
            $('#search_data').on('click', function () {
                ...
                $.ajax({
                    type: 'post',
                    url: '/generate/member-resign/get-data',
