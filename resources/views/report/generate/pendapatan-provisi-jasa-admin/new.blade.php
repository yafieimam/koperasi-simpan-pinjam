...
@section('title', 'Generate Report Pendapatan Provisi Jasa Admin')

@section('content_header')
    <h1>Generate Report Pendapatan Provisi Jasa Admin</h1>
@stop
...
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <div class="box-body">
                    {!! Form::open(['url' => 'generate/pendapatan-provisi-jasa-admin', 'method' => 'post']) !!}
                    @include('report.generate.pendapatan-provisi-jasa-admin.form')
                    {!! Form::close() !!}
                    ...
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <th scope="col" style="text-align: center;">Pendapatan Provisi</th>
                            <th scope="col" style="text-align: center;">Pendapatan Jasa</th>
                            <th scope="col" style="text-align: center;">Pendapatan Admin</th>
...
@section('appjs')
    ...
    <script type="text/javascript">
        $('.cari_area').select2({
            ...
            // allowClear: true,
            ajax: {
                url: '/generate/pendapatan-provisi-jasa-admin/get-area',
                dataType: 'json',
                delay: 250,
        ...
        function getProyek(area = ''){
            $('.cari_proyek').select2({
                ...
                // allowClear: true,
                ajax: {
                    url: '/generate/pendapatan-provisi-jasa-admin/get-proyek',
                    dataType: 'json',
                    delay: 250,
        ...
        function getMember(area = '', proyek = ''){
            $('.cari_member').select2({
                ...
                // allowClear: true,
                ajax: {
                    url: '/generate/pendapatan-provisi-jasa-admin/get-member',
                    dataType: 'json',
                    delay: 250,
                    data: function (params) {
                        return {
        ...
        $(document).ready(function () {
            $('#search_data').on('click', function () {
                ...
                $.ajax({
                    type: 'post',
                    url: '/generate/pendapatan-provisi-jasa-admin/get-data',
