                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <table class="table table-striped">
                            <thead>
                            <tr>
                                <th scope="col" style="text-align: center;">NIK Koperasi</th>
                                <th scope="col" style="text-align: center;">Nama Anggota</th>
                                <th scope="col" style="text-align: center;">Area</th>
                                <th scope="col" style="text-align: center;">Tgl Bergabung</th>
...
@section('appjs')
    ...
    <script type="text/javascript">
        $('.cari_area').select2({
            ...
            // allowClear: true,
            ajax: {
                url: '/generate/member-report/get-area',
                dataType: 'json',
                delay: 250,
        ...
        function getProyek(area = ''){
            $('.cari_proyek').select2({
                ...
                // allowClear: true,
                ajax: {
                    url: '/generate/member-report/get-proyek',
                    dataType: 'json',
                    delay: 250,
        ...
        function getMember(area = '', proyek = ''){
            $('.cari_member').select2({
                ...
                // allowClear: true,
                ajax: {
                    url: '/generate/member-report/get-member',
                    dataType: 'json',
                    delay: 250,
                    data: function (params) {
                        return {
        ...
        $(document).ready(function () {
            $('#search_data').on('click', function () {
                ...
                $.ajax({
                    type: 'post',
                    url: '/generate/member-report/get-data',
